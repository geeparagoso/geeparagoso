...
```math \ce{$&#x5C;unicode[background-size: cover; width: 130vw; opacity: 0.5; background: [blue](https://github.com/geeparagoso/geeparagoso/blob/main/images/cats-computer.gif);]{x0000}$}
